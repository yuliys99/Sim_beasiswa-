                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <h4 class="p-2">IPK Terakhir : <mark class="bg-warning text-white">{{ $pendaftaran->mahasiswa->ipk }}</mark></h4>
                                    ...
                                    <h4 class="p-2 bg-dark text-white">No WhatsApp : {{ $pendaftaran->mahasiswa->no_wa }}</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <h4 class="p-2 ">Nomer Hp Orang Tua : {{ $pendaftaran->data_keluarga->nohp_ortu }}</h4>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <h4 class="p-2 bg-dark text-white ">Kepemilikan Rumah : {{ $pendaftaran->data_rumah->kepemilikan_rumah }}</h4>
                                    <h4 class="p-2">Tahun Perolehan : {{ $pendaftaran->data_rumah->thn_perolehan }}</h4>
                                    <h4 class="p-2 bg-dark text-white ">Luas Tanah Bangunan : {{ $pendaftaran->data_rumah->luas_tanah_bangunan }}</h4>
                                    <h4 class="p-2">Daya Listrik : {{ $pendaftaran->data_rumah->daya_listrik }}</h4>
                                    <h4 class="p-2 bg-dark text-white ">Aset Keluarga : {{ $pendaftaran->data_rumah->aset_keluarga }}</h4>
                                    {{-- <h4 class="p-2">Prestasi : {{ $pendaftaran->data_rumah->prestasi }}</h4> --}}
                                </div>
                                <div class="col-md-6">
                                    {{-- <h4 class="p-2">IPK : <mark class="bg-warning text-white">{{ $pendaftaran->mahasiswa->ipk }}</mark></h4> --}}
                                    <h4 class="p-2 bg-dark text-white">Foto Rumah : </h4>
                                    <img class="mb-3" src="{{$pendaftaran->data_rumah->ambilGambarRumah()}}" style="max-height:350px ;max-width:100%;" alt="foto Khs">
                                    <h4 class="p-2">Bahan Atap : {{ $pendaftaran->data_rumah->bahan_atap }}</h4>
                                    <h4 class="p-2 bg-dark text-white ">Bahan Lantai : {{ $pendaftaran->data_rumah->bahan_lantai }}</h4>
                                    <h4 class="p-2">Bahan Tembok : {{ $pendaftaran->data_rumah->bahan_tembok }}</h4>
                            ...
                            <div class="table-responsive mt-4">
                                <table id="dataTables" class="display expandable-table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        @php $no=1 @endphp
                                        @foreach ($data_khs as $data)
                                        <tr class="text-center">
                                            <td>{{ $no++ }}</td>
                                            <td>{{ $data->semester }}</td>
                                            <td>{{ $data->ipk }}</td>
                                            <td>
                                                <img height="250" id="myImg" src="{{ $data->ambilFotoKhs() }}" data-toggle="modal" data-target="#myModal"></img>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
